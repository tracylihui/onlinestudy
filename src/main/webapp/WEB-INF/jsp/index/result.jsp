...
<body>
	...
	<div class="main white" style="padding-top: 20px;">
		<div style="font-size: 18px; font-family: '微软雅黑'; color: red;text-align: center; margin-top: 30px;">
			考试科目：${examtype.name }
		</div>
		<div style="font-size: 16px; font-family: '微软雅黑'; text-align: center;margin-top: 30px;">
			考试人：${indexLogin.username }
		</div>
		<div style="font-size: 20px; font-family: '微软雅黑'; color: red;text-align: center;margin-top: 30px; margin-bottom: 100px;">
			分数：${grade }
		</div>
		<c:forEach items="${questionDtos }" var="questionDto" varStatus="status">
			<dl style="overflow:auto; min-height:60px; width: 840px; margin-left: 60px; margin-top:20px; font-size: 14px; font-family: '微软雅黑'">
        		...
        		<dd style="float:left;width: 790px;">
        			...
        			<font color="red">正确答案：${questionDto.question.theoption }</font><br>
        			<font color="red">你的答案：${questionDto.yourOption }</font>
        		</dd>
			</dl>
