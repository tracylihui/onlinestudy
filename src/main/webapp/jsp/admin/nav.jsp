		...
		<c:if test="${isAdmin }">
			<ul class="navMenu navSelected">
				...
				<li class="navChild"><a
					...
					target="content">用户信息管理</a></li>
				<li class="navChild"><a
					href="<%=request.getContextPath()%>/admin/group/groups"
					target="content">用户组管理</a></li>
				<li class="navChild"><a
					href="<%=request.getContextPath()%>/admin/role/roles"
					target="content">用户角色管理</a></li>
			</ul>

			<ul class="navMenu navSelected">
				<h3 class="navTitle">
					<span class="navTilteTxt">考试管理</span>
				</h3>
				<li class="navChild"><a
					href="<%=request.getContextPath()%>/admin/examtype/examtypes"
					target="content">考试类型管理</a></li>
			</ul>
			<ul class="navMenu navSelected">
				<h3 class="navTitle">
				...
				<li class="navChild"><a
					href="<%=request.getContextPath()%>/admin/topic/audits"
			...
			<ul class="navMenu navSelected">
				...
				<li class="navChild"><a
					href="<%=request.getContextPath()%>/admin/backups"
